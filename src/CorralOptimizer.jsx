...
const CorralOptimizer = () => {
  ...
  return (
    <>
      <header className="max-w-6xl mx-auto bg-teal-600 text-white p-6 shadow-md flex-shrink-0 rounded-t-xl">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold flex items-center gap-2">
              <SquareSplitVertical className="w-6 h-6 text-yellow-400" />
              CorralOptimizer
            </h1>
            <p className="text-teal-200 text-sm mt-1">Proyecto de Cálculo I</p>
          </div>
          <div className="text-right text-xs text-teal-200 md:block">
            <p>J.A. Céspedes • M.A. Meneses • W.G. Trujillo</p>
            <p>Grupo 52</p>
          </div>
        </div>
      </header>
      <div className="max-w-6xl mx-auto p-6 bg-slate-50 rounded-b-xl shadow-lg font-sans">
...
export default CorralOptimizer;